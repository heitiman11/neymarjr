...
:root {
  ...
  --bs-link-color: #031633;
  --bs-link-hover-color: #021229;
...
.table-secondary {
  --bs-table-color: #000;
  --bs-table-bg: #cdd5e0;
  --bs-table-border-color: #b9c0ca;
  --bs-table-striped-bg: #c3cad5;
  --bs-table-striped-color: #000;
  --bs-table-active-bg: #b9c0ca;
  --bs-table-active-color: #000;
  --bs-table-hover-bg: #bec5cf;
  --bs-table-hover-color: #000;
  color: var(--bs-table-color);
  border-color: var(--bs-table-border-color);
}
...
.form-control:focus {
  ...
  border-color: #818b99;
  outline: 0;
  box-shadow: 0 0 0 0.25rem rgba(3, 22, 51, 0.25);
}
...
.form-switch .form-check-input:focus {
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='%23818b99'/%3e%3c/svg%3e");
}
...
.form-range:focus::-webkit-slider-thumb {
  box-shadow: 0 0 0 1px #fff, 0 0 0 0.25rem rgba(3, 22, 51, 0.25);
}
...
.dropdown-menu {
  ...
  --bs-dropdown-link-active-bg: #031633;
...
.accordion {
  ...
  --bs-accordion-btn-active-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%2303142e'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
  --bs-accordion-btn-focus-border-color: #818b99;
  --bs-accordion-btn-focus-box-shadow: 0 0 0 0.25rem rgba(3, 22, 51, 0.25);
  --bs-accordion-body-padding-x: 1.25rem;
  --bs-accordion-body-padding-y: 1rem;
  --bs-accordion-active-color: #03142e;
  --bs-accordion-active-bg: #e6e8eb;
}
...
.pagination {
  ...
  --bs-pagination-focus-box-shadow: 0 0 0 0.25rem rgba(3, 22, 51, 0.25);
  --bs-pagination-active-color: #fff;
  --bs-pagination-active-bg: #031633;
  --bs-pagination-active-border-color: #031633;
...
.alert-primary {
  --bs-alert-color: #020d1f;
  --bs-alert-bg: #cdd0d6;
  --bs-alert-border-color: #b3b9c2;
}
...
.alert-secondary {
  --bs-alert-color: #031a3d;
  --bs-alert-bg: #cdd5e0;
  --bs-alert-border-color: #b4c0d1;
}
...
.list-group {
  ...
  --bs-list-group-active-bg: #031633;
  --bs-list-group-active-border-color: #031633;
  display: flex;
  flex-direction: column;
  padding-left: 0;
  margin-bottom: 0;
